...
public class test {
    ...
    public static void main(String[] args) {
        ...
        Graph testGraph = GraphBuilder.newBuilder().build();
        Parser testParser = new Parser(testGraph);
        testParser.parse(b2);
